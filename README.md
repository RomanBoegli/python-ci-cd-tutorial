...
This repository represents **OptimizHelper** -- a small tiny command line interface tool for solving (non)integer and network optimization problems. You don't need to understand its internals; it's simply a realistic Python codebase to wire up a pipeline around and serves as the target project for this tutorial.
...
In case you are curious about what the tool actually does, follow the setup below and see the [EXAMPLES.md](EXAMPLES.md).
However, it's not required for this tutorial.
